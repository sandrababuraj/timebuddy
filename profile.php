...
<body>
    ...
    <div class="bgimg">
        ...
        <div class="steps">
            ...
            <div><a href="generate.php" class="tablinks <?php echo (isset($_GET['tab']) && $_GET['tab'] == 'addlabs') ? 'active' : ''; ?>"><button>Generate<br>Odd<br>Sem</button></a></div>
            <div><a href="generate1.php" class="tablinks <?php echo (isset($_GET['tab']) && $_GET['tab'] == 'addlabs') ? 'active' : ''; ?>"><button>Generate<br>Even<br>Sem</button></a></div>
        </div>
    </div>
</body>
