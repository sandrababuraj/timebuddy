...
$year = $sem = $dept = $class = $lab = $teacher = $weekhr = '';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO labs (year, sem, dept, class, lab, teacher, weekhr) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("isssssi", $year, $sem, $dept, $class, $lab, $teacher, $weekhr);
    ...
    <div class="bgimg">
        ...
        <div class="form">
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <div class="form-group">
                    <label>Lab</label><br>
                    <input type="text" name="lab" value="<?php echo htmlspecialchars($lab); ?>"><br>
                    <span class="error"><?php echo isset($errors['lab']) ? $errors['lab'] : ''; ?></span>
                </div>
                <div class="form-group">
        ...
        <div class="prevnext">
        <a href="addsub.php" class="previous">&laquo; Previous</a>
        <a href="input.php" class="next">Next &raquo;</a>

        <a href="addsub.php" class="previous round">&#8249;</a>
        <a href="generate.php" class="next round">&#8250;</a>
        </div>
    </div>
</body>
