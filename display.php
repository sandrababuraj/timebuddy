...
<body>
    ...
    <div class="bgimg">
        ...
        <div class="steps">
            <div><a href="display4.php" class="tablinks <?php echo (isset($_GET['tab']) && $_GET['tab'] == 'addsubjects') ? 'active' : ''; ?>"><button>Class Timetable</button></a></div>
            <div><a href="display5.php" class="tablinks <?php echo (isset($_GET['tab']) && $_GET['tab'] == 'addlabs') ? 'active' : ''; ?>"><button>Teacher's Timetable</button></a></div>
            <div><a href="display2.php" class="tablinks <?php echo (isset($_GET['tab']) && $_GET['tab'] == 'generate') ? 'active' : ''; ?>"><button>Dept Timetable</button></a></div>
            <div><a href="edit.php" class="tablinks <?php echo (isset($_GET['tab']) && $_GET['tab'] == 'generate') ? 'active' : ''; ?>"><button>Edit Timetable</button></a></div>
